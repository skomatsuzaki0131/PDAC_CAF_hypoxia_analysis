...
# before integration. This block reads the QC-filtered objects, merges them,
# performs Harmony integration, and conducts initial clustering.
#
# Final parameters used for the manuscript:
# - Samples: TX5K_02, TX5K_19, TX5K_11, TX5K_16, TX5K_01, TX5K_15
# - QC thresholds: nFeature_RNA 100–900, nCount_RNA 100–1800
# - Integration method: Harmony
# - Variable features: 2,000 genes
# - PCA dimensions: 50
# - UMAP/clustering dimensions: 20
# - Initial clustering resolution: 1.0
